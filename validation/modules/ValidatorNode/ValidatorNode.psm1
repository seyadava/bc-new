...
try {
    ...
    . ("$ScriptDirectory\Tests\ValidatorMultiMemberTest.ps1")
...
class ValidatorNode {
    ...
    [String] VoteForAdmin([String]$fromAccountAddress, [String]$voteForAccount, [String]$privateKey) {        
        # Returns the transaction hash
        $transactionHash = $this.ExecuteWeb3Method("voteFor", ($fromAccountAddress, $voteForAccount, $privateKey))
        return $transactionHash
    }
    ...
    [String] AddValidator([String]$fromAccountAddress, [String]$newValidatorAddress, [String]$privateKey) {        
        # Returns the transaction hash
        $transactionHash = $this.ExecuteWeb3Method("addValidator", ($fromAccountAddress, $newValidatorAddress, $privateKey))
        return $transactionHash
    }
