...
$param.Add("vlStorageAccountType", "StandardSSD_LRS")
...
$param.Add("deployUsingPublicIP", $deployUsingPublicIP)
#$param.Add("transactionPermissioningContract", "BYTE_CODE_GOES_HERE")
...
#Usage: ./LeaderDeploy.ps1 ldr_rg https://stgdev.blob.core.windows.net/devbox/ethereum-consortium-blockchain-network/common/mainTemplate.json https://stgdev.blob.core.windows.net/devbox/ethereum-consortium-blockchain-network/common eastus 0 ldr
